...
# Purpose: Creates OU and Users in Active Directory using a imported CSV file with user details
# Prerequisites: PGDipCLOD2022.csv (list of users to be imported)
